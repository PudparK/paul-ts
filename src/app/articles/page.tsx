...
export default async function ArticlesIndex() {
  ...
  return (
    <SimpleLayout
      title="Writing about software, systems, and the realities of building in the real world."
      intro="Long-form thoughts on programming, leadership, product design, and everything I’m still figuring out."
    >
